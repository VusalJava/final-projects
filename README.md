#Это учебный, командный проект по прототипу интернет магазина(avito), который не завершен.
#Мы разрабатывали данное приложение исключительно в образовательных целях. 
## Сущности
